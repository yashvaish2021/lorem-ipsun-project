...
const noOfParagraph = window.document.querySelector("#amount");
const loremForm = window.document.querySelector(".lorem-form");
const articleContainer = window.document.querySelector(".lorem-text");

loremForm.addEventListener("submit", function (e) {
  e.preventDefault();
  const value = parseInt(noOfParagraph.value);
